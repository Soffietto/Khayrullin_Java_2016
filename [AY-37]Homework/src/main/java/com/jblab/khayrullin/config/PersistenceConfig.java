package com.jblab.khayrullin.config;
...
@EnableJpaRepositories("com.jblab.khayrullin.repository")
...
public class PersistenceConfig implements EnvironmentAware {
    ...
    public EntityManagerFactory entityManagerFactory() throws PropertyVetoException, IOException {
        ...
        entityManagerFactory.setPackagesToScan("com.jblab.khayrullin.model");
